...
func (x *MsgResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_hello_hellopb_hello_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x22, 0x26, 0x0a, 0x0a, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x25, 0x0a, 0x0b, 0x4d, 0x73,
	...
	0x74, 0x32, 0x40, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x30, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x11, 0x2e, 0x68, 0x65, 0x6c,
	0x6c, 0x6f, 0x2e, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e,
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2f, 0x68,
...
var file_hello_hellopb_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_hello_hellopb_hello_proto_goTypes = []interface{}{
	(*MsgRequest)(nil),  // 0: hello.MsgRequest
	(*MsgResponse)(nil), // 1: hello.MsgResponse
}
var file_hello_hellopb_hello_proto_depIdxs = []int32{
	0, // 0: hello.HelloService.Hello:input_type -> hello.MsgRequest
	1, // 1: hello.HelloService.Hello:output_type -> hello.MsgResponse
...
type HelloServiceClient interface {
	Hello(ctx context.Context, in *MsgRequest, opts ...grpc.CallOption) (*MsgResponse, error)
}
...
func (c *helloServiceClient) Hello(ctx context.Context, in *MsgRequest, opts ...grpc.CallOption) (*MsgResponse, error) {
	out := new(MsgResponse)
...
type HelloServiceServer interface {
	Hello(context.Context, *MsgRequest) (*MsgResponse, error)
}
...
func (*UnimplementedHelloServiceServer) Hello(context.Context, *MsgRequest) (*MsgResponse, error) {
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).Hello(ctx, req.(*MsgRequest))
	}
